...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(70, 30, 113, 20))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.label_5 = QtWidgets.QLabel(parent=Dialog)
        self.label_5.setGeometry(QtCore.QRect(40, 80, 47, 13))
        self.label_5.setObjectName("label_5")
        self.label_2 = QtWidgets.QLabel(parent=Dialog)
        self.label_2.setGeometry(QtCore.QRect(30, 10, 47, 13))
        self.label_2.setObjectName("label_2")
        self.comboBox = QtWidgets.QComboBox(parent=Dialog)
        self.comboBox.setGeometry(QtCore.QRect(70, 80, 69, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "rol"))
        self.label_2.setText(_translate("Dialog", "nombre"))
        self.label_3.setText(_translate("Dialog", "clave"))
